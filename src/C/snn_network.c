...
void initialize_network(int neurons_per_layer[],
    ...
    for (int l = 0; l < snn_network.num_layers; l++) {
        ...
        if (l == 1) {
            ...
            memset(snn_network.layers[l].voltage_thresholds, VOLTAGE_THRESH_FP7, snn_network.layers[l].num_neurons * sizeof(int32_t));
            memset(snn_network.layers[l].decay_rates, DECAY_FP7, snn_network.layers[l].num_neurons * sizeof(int32_t));
#else
